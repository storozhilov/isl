...
template <typename Msg, typename Cloner = CopyMessageCloner<Msg> > class MessageBus
{
public:
	class Subscriber
	{
	public:
		Subscriber(MessageBus<Msg>& bus, MessageQueue<Msg, Cloner>& queue) :
			_bus(bus),
			_queue(queue)
		{
...
private:
	...
	typedef std::set<MessageQueue<Msg, Cloner> *> Subscriptions;
